...
|[Null object](https://en.wikipedia.org/wiki/Null_object_pattern)|Avoid null references by providing a default object.|[PHP](Behavioral/Null-object)|
...
|[Visitor](https://en.wikipedia.org/wiki/Visitor_pattern)|Represent an operation to be performed on the elements of an object structure. |[C++](Behavioral/Visitor) [PHP](Behavioral/Visitor/Visitor.php)|
